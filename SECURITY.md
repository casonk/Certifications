...
For `Certifications`, security-sensitive reports should be handled privately by the repository owner.
...
- Do not commit unpublished certificates, private account links, or extra personal identifiers beyond what is intentionally public.
